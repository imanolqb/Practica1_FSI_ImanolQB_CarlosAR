...
class branchAndBoundQueue(Queue):
    """A First-In-First-Out Queue for Branch and Bound algorithm."""
...
class branchAndBoundQueueHeuristic(Queue):
    ...
    def __init__(self, problem):
        self.A = []
        self.problem = problem                                          # Heurística

    def append(self, element):
        self.A.append(element)

    def takeHeuristic(self, element):
        return element.path_cost + self.problem.h(element)              # Sumamos la heurística esperada al coste del camino
